...
Instead of starting with 1 stack, ideal flow of logical thinking would have been starting with 1 queue (BFS) and then intead use 2 stacks 
after identifying the problem of maintaining level info. From this interviewer can easily make out you knew the solution 
(minor point, does not matter if the interviewer thinks so in many cases, shows preparation)
...
Feedback:
Behavioral:
	Typically for a new hire, how long does it take a new hire to ramp up on training?
